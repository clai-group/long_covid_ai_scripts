...
J <- J %>%
  ...
  filter(!(phenx %in% c("Administration of albumin and globulin","Transfusion of blood and blood products"
                        ...
                        , "Injury to nerves, muscles and tendons"
                        , "Injury, sequela"
                        ...
                        , "Maltreatment/abuse"
                        , "Effect of foreign body entering opening, subsequent encounter"
                        , "Adverse effects of drugs and medicaments, initial encounter"
                        , "Adverse effects of drugs and medicaments, subsequent encounter"
                        ...
                        , "Encounter for prophylactic or other procedures"
                        ...
                        , "Multiple gestation"
                        , "Hemorrhoids"
                        , "Anesthesia complications during pregnancy"
                        , "Obstetric history affecting care in pregnancy"
                        , "Abdominal hernia"
